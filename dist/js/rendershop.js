 ...
 * @LastEditors: Ankang
 * @LastEditTime: 2021-05-15 19:47:09
 */
// 账号登录状态
...
function renderShop(data) {
  ...
  shoppic.src = bigshoppic.src = data.imgaddress; // console.log(shoppic.src)

  shoppicList.forEach(function (item, index) {
  ...
  name.innerHTML = data.name; // $(name).attr["data"]=data.id;
...
function cookie(name, value, options) {
  if (typeof name === "string" && typeof value === "string") {
    ...
    return document.cookie = [name, "=", value, typeof options.path === "string" ? ";path=" + options.path : "", typeof options.domain === "string" ? ";domain=" + options.domain : "", typeof options.expires === "number" ? ";expires=" + d : ""].join("");
  }
